...
Reciter.loadData = function(){
	$.ajax({
		...
		success: function(json) {
			...
			Reciter.initList();// prepare UI list
		},
...
Reciter.keyDown = function()
{
	...
	switch(keyCode)
	{
		...
		case tvKey.KEY_LEFT:alert("Reciter LEFT");Reciter.previousPage();break;
		case tvKey.KEY_RIGHT:alert("Reciter RIGHT");Reciter.nextPage();break;
		case tvKey.KEY_UP:Reciter.up();break;
		case tvKey.KEY_DOWN:Reciter.down();break;
		case tvKey.KEY_ENTER:Sura.loadData(reciterList[a].rnumber);break;
