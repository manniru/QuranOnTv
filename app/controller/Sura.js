...
Sura.loadData = function(rnumber){
	$.ajax({
...
Sura.keyDown = function()
{
	...
	switch(keyCode)
	{
		...
		case tvKey.KEY_DOWN:Sura.down();$('#tvkey').html("Sura DOWN");break;
		...
		case tvKey.KEY_UP:$('#tvkey').html("Sura UP");Sura.up();break;
